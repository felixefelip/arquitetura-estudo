        ...
        module ActiveRecord
          class Impl
            ...
            def buscar_por_cpf(cpf)
              ...
              aluno = Academico::Aluno::Domain::Entity.new(nome: record.nome, email: record.email, cpf: record.cpf)
            ...
            def buscar_todos
              Record.all.map do |record|
                Academico::Aluno::Domain::Entity.new(nome: record.nome, email: record.email, cpf: record.cpf)
              end
            end
          end
        end
